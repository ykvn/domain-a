...
spark = SparkSession.builder \
    .appName("merge_revenue_ifrs_dd_stg_breakage") \
    .config(conf=conf) \
    .enableHiveSupport() \
    .getOrCreate()
...
table_5 = "testing.breakage_reference_poc_tokenized"
...
df.createOrReplaceTempView("temp_stg_breakage_poc_tokenized")

# Then use Spark SQL to insert overwrite into the target Hive table
spark.sql("""
INSERT OVERWRITE TABLE testing.stg_breakage_poc_tokenized
PARTITION (event_date)
SELECT *
FROM temp_stg_breakage_poc_tokenized
""")
