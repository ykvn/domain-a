...
spark = SparkSession.builder \
    .appName("mkios_evcrec_evcvas_ngrs_reject_poc_tokenized_merge") \
    .config(conf=conf) \
    .enableHiveSupport() \
    .getOrCreate()
...
#define table
table_source = "usecase_1.mkios_evcrec_evcvas_ngrs_reject_poc_tokenized"
table_target = "testing.mkios_evcrec_evcvas_ngrs_reject_poc_tokenized"
