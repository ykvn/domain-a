...
spark = SparkSession.builder \
    .appName("ifrs_cons_rate_and_outstanding_dd_poc_tokenized_merge") \
    .config(conf=conf) \
    .enableHiveSupport() \
    .getOrCreate()
...
#define table
table_source = "usecase_1.ifrs_cons_rate_and_outstanding_dd_poc_tokenized"
table_target = "testing.ifrs_cons_rate_and_outstanding_dd_poc_tokenized"
