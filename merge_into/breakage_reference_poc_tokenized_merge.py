...
spark = SparkSession.builder \
    .appName("breakage_reference_poc_tokenized_merge") \
    .config(conf=conf) \
    .enableHiveSupport() \
    .getOrCreate()
...
#define table
table_source = "usecase_1.breakage_reference_poc_tokenized"
table_target = "testing.breakage_reference_poc_tokenized"
