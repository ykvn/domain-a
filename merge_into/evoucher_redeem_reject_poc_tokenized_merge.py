...
spark = SparkSession.builder \
    .appName("evoucher_redeem_reject_poc_tokenized_merge") \
    .config(conf=conf) \
    .enableHiveSupport() \
    .getOrCreate()
...
#define table
table_source = "usecase_1.evoucher_redeem_reject_poc_tokenized"
table_target = "testing.evoucher_redeem_reject_poc_tokenized"
...
QUERY = f"""
    ...
    USING (SELECT * FROM {table_source}) s
    ON s.event_date = t.event_date
    AND s.sne = t.sne
    AND s.redeem_state = t.redeem_state
