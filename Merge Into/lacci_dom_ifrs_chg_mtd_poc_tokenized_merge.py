...
spark = SparkSession.builder \
    .appName("lacci_dom_ifrs_chg_mtd_poc_tokenized_merge") \
    .config(conf=conf) \
    .enableHiveSupport() \
    .getOrCreate()
...
#define table
table_source = "usecase_1.lacci_dom_ifrs_chg_mtd_poc_tokenized"
table_target = "testing.lacci_dom_ifrs_chg_mtd_poc_tokenized"
