...
spark = SparkSession.builder \
    .appName("ifrs_bonus_seizure_poc_tokenized_merge") \
    .config(conf=conf) \
    .enableHiveSupport() \
    .getOrCreate()
...
#define table
table_source = "usecase_1.ifrs_bonus_seizure_poc_tokenized"
table_target = "testing.ifrs_bonus_seizure_poc_tokenized"
