...
spark = SparkSession.builder \
    .appName("ifrs_accrual_product_daily_poc_tokenized_merge") \
    .config(conf=conf) \
    .enableHiveSupport() \
    .getOrCreate()
...
#define table
table_source = "usecase_1.ifrs_accrual_product_daily_poc_tokenized"
table_target = "testing.ifrs_accrual_product_daily_poc_tokenized"
...
QUERY = f"""
    ...
    PARTITION (event_date, load_date)
