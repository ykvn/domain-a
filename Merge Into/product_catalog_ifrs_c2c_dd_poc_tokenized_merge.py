...
spark = SparkSession.builder \
    .appName("product_catalog_ifrs_c2c_dd_poc_tokenized_merge") \
    .config(conf=conf) \
    .enableHiveSupport() \
    .getOrCreate()
...
#define table
table_source = "usecase_1.product_catalog_ifrs_c2c_dd_poc_tokenized"
table_target = "testing.product_catalog_ifrs_c2c_dd_poc_tokenized"
